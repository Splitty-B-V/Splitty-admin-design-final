...
export default function Support() {
  ...
  const getStatusColor = (status) => {
    switch (status) {
      case 'open': return false ? 'text-yellow-400' : 'text-yellow-600'
      case 'resolved': return false ? 'text-green-400' : 'text-green-600'
      case 'pending': return false ? 'text-gray-400' : 'text-gray-500'
      default: return false ? 'text-gray-400' : 'text-gray-500'
    }
  }
          ...
          <div className={`w-96 flex flex-col border-r flex-shrink-0 h-full overflow-hidden ${
            ...
            <div className="flex-shrink-0">
              ...
              <div className={`px-6 py-4 border-b ${
                false ? 'border-[#1c1e27]' : 'border-gray-200'
              }`}>
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-3 flex-1 text-left">
                      ...
                      <p className={`text-sm mt-1 ${
                        conversation.unread 
                          ? false ? 'text-white font-medium' : 'text-gray-900 font-medium'
              ...
              <div className="flex-1 flex flex-col">
                <div className="flex-1 flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <p className={false ? 'text-[#BBBECC]' : 'text-gray-600'}>
