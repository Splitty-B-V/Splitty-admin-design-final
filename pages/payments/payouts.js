        ...
        <div className="px-4 sm:px-6 lg:px-8 py-8">
          <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
              <div>
                <h1 className={`text-2xl font-semibold ${false ? 'text-white' : 'text-[#111827]'} mb-1`}>Restaurant Uitbetalingen</h1>
                <p className={`${false ? 'text-[#BBBECC]' : 'text-[#6B7280]'}`}>Compleet overzicht van alle restaurant uitbetalingen en transacties</p>
              </div>
              <button
                type="button"
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-5">
              <div className={`p-6 rounded-xl ${
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <p className={`text-xs font-medium uppercase tracking-wider ${false ? 'text-[#BBBECC]' : 'text-[#6B7280]'}`}>TOTAAL UITBETALINGEN</p>
              ...
              <div className={`p-6 rounded-xl ${
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <p className={`text-xs font-medium uppercase tracking-wider ${false ? 'text-[#BBBECC]' : 'text-[#6B7280]'}`}>UITBETAALD</p>
              ...
              <div className={`p-6 rounded-xl ${
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <p className={`text-xs font-medium uppercase tracking-wider ${false ? 'text-[#BBBECC]' : 'text-[#6B7280]'}`}>IN BEHANDELING</p>
              ...
              <div className={`p-6 rounded-xl ${
                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <p className={`text-xs font-medium uppercase tracking-wider ${false ? 'text-[#BBBECC]' : 'text-[#6B7280]'}`}>RESTAURANTS</p>
