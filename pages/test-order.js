            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
              <div>
                <h1 className="text-2xl font-semibold text-[#111827] mb-1">
                  Test Bestelling Simulator
                </h1>
                <p className="text-[#6B7280]">
                  Test de volledige bestelflow zonder echte transacties
                </p>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
              <div className={`p-4 rounded-xl border transition-all ${
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3 flex-1">
                    <label className="block text-sm font-medium mb-2 text-gray-900">Selecteer Restaurant</label>
                    <select
              ...
              <div className={`p-4 rounded-xl border transition-all ${
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3 flex-1">
                    <label className="block text-sm font-medium mb-2 text-gray-900">Tafelnummer</label>
                    <input
                      type="text"
                      value={tableNumber}
                      onChange={(e) => setTableNumber(e.target.value)}
                      placeholder="bijv. 12, A3, Terras-5"
              ...
              <div className="lg:col-span-1">
                    ...
                    <div className="p-4 border-t border-gray-200 bg-gray-50">
                      ...
                      {(!selectedRestaurant || !tableNumber) && (
                        <p className="text-xs text-center mt-2 text-red-600">
                          {!selectedRestaurant ? 'Selecteer eerst een restaurant' : 'Voer een tafelnummer in'}
                        </p>
                      )}
                    </div>
                  )}
                ...
                <div className="mt-4 p-4 rounded-xl border bg-blue-50 border-blue-200">
                  <div className="flex items-start">
                    ...
                    <div className="ml-3">
                      <h4 className="text-sm font-medium mb-1 text-blue-900">Test Modus Info</h4>
                      <p className="text-xs text-blue-700">
                        Deze bestelling wordt alleen gesimuleerd. Er worden geen echte transacties uitgevoerd.
                      </p>
                    </div>
                  </div>
                </div>
